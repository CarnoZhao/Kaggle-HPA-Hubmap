### copy from https://github.com/fidler-lab/hila/blob/main/mmseg/models/backbones/hila_segformer.py
# ---------------------------------------------------------------
...
from .hila import TopDownAttn, BottomUpAttn
...
class HILAMixVisionTransformer(nn.Module):
...
class hila_mit_b2(HILAMixVisionTransformer):
    def __init__(self, **kwargs):
        super(hila_mit_b2, self).__init__(embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
