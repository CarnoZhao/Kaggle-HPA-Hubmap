### inference https://github.com/microsoft/CSWin-Transformer/blob/main/models/cswin.py
# ------------------------------------------
# CSWin Transformer
...
## copy from https://github.com/microsoft/CSWin-Transformer/blob/main/segmentation/backbone/cswin_transformer.py
class Mlp(nn.Module):
